#
#  Be sure to run `pod spec lint Xcode9to10Preparation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "RomanPodymov"
  # s.authors            = { "RomanPodymov" => "podymfrombryansk@yandex.ru" }
  # s.social_media_url   = "http://twitter.com/RomanPodymov"
  ...
  s.source       = { :git => "https://github.com/RomanPodymov/Xcode9to10Preparation.git", :tag => "#{s.version}" }
